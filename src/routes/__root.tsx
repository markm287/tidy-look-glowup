...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Radiance Med Spa — Aesthetic & Wellness Services in Chambersburg, PA" },
      { name: "description", content: "Physician-led med spa in Chambersburg, PA. Botox, microneedling, laser hair removal, RF, chemical peels, skincare, weight loss, peptides & GLP." },
      { name: "author", content: "Lovable" },
      { name: "google-site-verification", content: "OygmQAdWWaQAW4YI3ZqUknubsD48TC3ps5q-0NDWWPc" },
      { property: "og:title", content: "Radiance Med Spa — Aesthetic & Wellness Services in Chambersburg, PA" },
