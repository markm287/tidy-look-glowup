...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:description", content: "Radiance Med Spa in Chambersburg, PA — refined aesthetic treatments, injectables, and skin care in an elegant setting." },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          url: "https://tidy-look-glowup.lovable.app",
