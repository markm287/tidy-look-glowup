...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "Botox, Fillers, Sculptra, Radiesse | Chambersburg, PA" },
      {
        name: "description",
        content:
      ...
      { property: "og:title", content: "Botox, Fillers, Sculptra, Radiesse | Chambersburg, PA" },
      {
      ...
      { name: "twitter:title", content: "Botox, Fillers, Sculptra, Radiesse | Chambersburg, PA" },
      {
